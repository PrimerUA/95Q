package top.comic.pkg.fragments;

import java.util.ArrayList;
import java.util.List;
import java.util.Random;

import top.comic.pkg.NewQuoteScreen;
import top.comic.pkg.R;
import top.comic.pkg.adapters.QuoteListAdapter;
import top.comic.pkg.adapters.UserQuoteListAdapter;
import top.comic.pkg.core.CoreFragment;
import top.comic.pkg.data.Quote;
import top.comic.pkg.data.Show;
import top.comic.pkg.data.ShowsList;
import top.comic.pkg.entity.UserQuote;
import top.comic.pkg.server.Executor;
import top.comic.pkg.util.controllers.LanguageController;
import top.comic.pkg.util.controllers.LanguageController.LanguageChanger;
import top.comic.pkg.util.providers.ConnectionProvider;
