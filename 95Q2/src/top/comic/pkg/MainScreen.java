...
import top.comic.pkg.core.FragmentsGenerator;
import top.comic.pkg.data.ShowsList;
import top.comic.pkg.entity.User;
import top.comic.pkg.fragments.MainFragment;
import top.comic.pkg.messages.ExitDialog;
import top.comic.pkg.util.AppRater;
import top.comic.pkg.util.PreferencesLoader;
import top.comic.pkg.util.controllers.BackgroundController;
import top.comic.pkg.util.controllers.DailyNotificationController;
